...
#In Seurat, we also use the ScaleData() function to remove unwanted sources of 
#variation from a single-cell dataset. For example, we could ‘regress out’ 
#heterogeneity associated with (for example) cell cycle stage, or mitochondrial 
#contamination
